...
sheet = workbook.worksheet("KPD")  # Лист в таблице

sheet.batch_clear(['A:B'])  # Очищаем два первых столбца
set_with_dataframe(sheet, all_hours, row=2, col=1, include_index=True)  # Выгружаем данные в Google sheet
